...
Обладаю глубоким пониманием принципов объектно-ориентированного программирования, паттернов проектирования и методологий, таких как TDD (разработка через тестирование), Spring security + JWT и базовые принципы SOLID, стремясь к чистому и легкому коду. 

Приветствую простые и интуитивно понятные подходы к проектированию, а также готов к освоению новых методологий и приемов для более эффективной работы в мире Java-разработки.
