...
<b style="color: #6db33f;">Spring Boot</b>, 
<b style="color: #336791;">PostgreSQL</b>, 
<b style="color: #231f20;">Kafka</b> и 
<b style="color: #0db7ed;">Docker</b>. 

У меня есть опыт работы с микросервисной архитектурой, мониторингом с использованием 
<b style="color: #f46800;">Grafana</b> и 
<b style="color: #e6522c;">Prometheus</b>, проектированием и разработкой RESTful сервисов, оптимизацией SQL-запросов, а также разработкой 
<b style="color: #3ddc84;">Android-приложений</b>. 

Я активно использую системы контроля версий 
<b style="color: #f05032;">Git</b> для управления кодом и обеспечения совместной работы в команде.
